...
$string['inlinesections'] = 'Separate groups into lines';
$string['inlinesections_help'] = 'Indicate if each button group should be shown on its own line (Yes), or if all groups should flow together, centered, on the same line, wrapping only when there is no room left (No)';
$string['zero'] = 'Zero';
$string['one'] = 'One';
$string['two'] = 'Two';
$string['three'] = 'Three';
