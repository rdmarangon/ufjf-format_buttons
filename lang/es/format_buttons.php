...
$string['inlinesections'] = 'Separar grupos en líneas';
$string['inlinesections_help'] = 'Indique si cada grupo de botones debe mostrarse en su propia línea (Sí) o si todos los grupos deben fluir juntos, centrados, en la misma línea, saltando de línea solo cuando no quede espacio (No)';
$string['zero'] = 'Cero';
$string['one'] = 'Uno';
$string['two'] = 'Dos';
$string['three'] = 'Tres';
